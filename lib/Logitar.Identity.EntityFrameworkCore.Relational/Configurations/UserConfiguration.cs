...
public sealed class UserConfiguration : AggregateConfiguration<UserEntity>, IEntityTypeConfiguration<UserEntity>
{
  ...
  public override void Configure(EntityTypeBuilder<UserEntity> builder)
  {
    ...
    builder.ToTable(IdentityDb.Users.Table.Table ?? string.Empty, IdentityDb.Users.Table.Schema);
    ...
    {
      joinBuilder.ToTable(IdentityDb.UserRoles.Table.Table ?? string.Empty, IdentityDb.UserRoles.Table.Schema);
