...
{
  public static readonly TableId Table = new(IdentityContext.Schema, nameof(IdentityContext.Users), alias: null);
  ...
  public static readonly ColumnId EntityId = new(nameof(UserEntity.EntityId), Table);
