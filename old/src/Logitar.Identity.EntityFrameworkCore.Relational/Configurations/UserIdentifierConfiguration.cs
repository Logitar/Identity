...
public class UserIdentifierConfiguration : IdentifierConfiguration<UserIdentifierEntity>, IEntityTypeConfiguration<UserIdentifierEntity>
{
  public override void Configure(EntityTypeBuilder<UserIdentifierEntity> builder)
  {
    base.Configure(builder);

    builder.ToTable(nameof(IdentityContext.UserIdentifiers));
