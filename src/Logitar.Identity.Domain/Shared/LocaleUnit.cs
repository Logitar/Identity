...
public record LocaleUnit
{
  ...
  public LocaleUnit(CultureInfo culture, string? propertyName = null) : this(culture.Name, propertyName)
  {
  }
  /// <summary>
  /// Initializes a new instance of the <see cref="LocaleUnit"/> class.
  ...
  {
    return string.IsNullOrWhiteSpace(code) ? null : new(code.Trim(), propertyName);
  }
}
