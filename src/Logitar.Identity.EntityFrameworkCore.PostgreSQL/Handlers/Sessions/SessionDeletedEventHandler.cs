...
/// <summary>
/// The handler for <see cref="SessionDeletedEvent"/> events.
/// </summary>
internal class SessionDeletedEventHandler : INotificationHandler<SessionDeletedEvent>
{
  ...
  /// <summary>
  /// Initializes a new instance of the <see cref="SessionDeletedEventHandler"/> class with the specified arguments.
  /// </summary>
  /// <param name="context">The identity database context.</param>
  /// <param name="logger">The logger instance.</param>
  public SessionDeletedEventHandler(IdentityContext context, ILogger<SessionDeletedEventHandler> logger)
  {
    _context = context;
    _logger = logger;
  }
