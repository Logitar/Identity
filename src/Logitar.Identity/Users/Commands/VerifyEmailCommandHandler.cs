...
/// </summary>
internal class VerifyEmailCommandHandler : IRequestHandler<VerifyEmailCommand, User>
{
  /// <summary>
  /// The current actor.
  /// </summary>
  ...
  public VerifyEmailCommandHandler(ICurrentActor currentActor,
  ...
  public async Task<User> Handle(VerifyEmailCommand command, CancellationToken cancellationToken)
  {
    ...
    if (user.Email != null)
    {
      user.SetEmail(_currentActor.Id, user.Email.Verify());
