...
/// </summary>
internal class VerifyPhoneCommandHandler : IRequestHandler<VerifyPhoneCommand, User>
{
  /// <summary>
  /// The current actor.
  /// </summary>
  ...
  public VerifyPhoneCommandHandler(ICurrentActor currentActor,
  ...
  public async Task<User> Handle(VerifyPhoneCommand command, CancellationToken cancellationToken)
  {
    ...
    if (user.Phone != null)
    {
      user.SetPhone(_currentActor.Id, user.Phone.Verify());
